...
setup(name='source_assess_treatment_efficacy',
      ...
      packages=['source_assess_treatment_efficacy/meta_analysis', 'source_assess_treatment_efficacy/systematic_analysis_of_biases'],
      zip_safe=False)