...
Surprisingly, the factor of the number of sessions was not found to be significant by any method, which was somewhat
in contradiction to existing literature. For instance, \citet{Arns2014} stated that performing less than
...
sessions should be carefully chosen carefully in order to avoid "overtraining". The fact that the number of sessions was not identified as a 
...
This can be explained by the fact that better signal quality enables the more accurate extraction of \gls{eeg} patterns
...
Next, it here appears here that the longer the course of treatment, the less efficient it becomes. Arguably, the treatment length is a
...
which is not common knowledge in this field.
...
Nonetheless, the emphasis put on \emph{probably} indicated that teachers may be aware of the treatment followed. 
