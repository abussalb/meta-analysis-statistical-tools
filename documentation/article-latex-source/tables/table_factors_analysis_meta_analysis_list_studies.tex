...
\toprule
\multicolumn{3}{ c }{Analysis} & Study & Year & \shortstack{ Size of the \gls{nfb} group } \\
\midrule
...
\cmidrule(lr){3-6}
 ...
 & \shortstack{b = Update \\ \citeauthor{Cortese2016} } & & 16 studies & & 394 \\
\cmidrule(lr){2-6}
