...
\toprule
\multicolumn{3}{ c }{Dataset} & Study & Year & \shortstack{ Size of the \\ Neurofeedback group } \\
\midrule
 ...
 & & \shortstack{ Replicate \\ \citeauthor{Cortese2016}$^a$ } & 13 studies & & 297 \\
\cmidrule(lr){3-6}
 & & & \citeauthor{Baumeister2016} & 2016 & 8 \\
 & & & \citeauthor{Strehl2017} & 2017 & 72 \\
 & \shortstack{ Update \\ \citeauthor{Cortese2016}$^b$ } & & 15 studies & & 377 \\
\cmidrule(lr){2-6}
 ...
 \shortstack{Systematic Analysis \\ of bias (\gls{saob})$^c$} & & & 32 studies & & 829 \\
\bottomrule
\end{tabular}
