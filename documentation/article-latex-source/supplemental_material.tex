...
variance $\tau^2$ is required. It was calculated in three steps described in Eq~\ref{eq:metareview_Q}, Eq~\ref{eq:metareview_C} and Eq~\ref{eq:metareview_Tau} 
...
All scales used for the meta-analysis are summarized here in order to facilitate the replication of this work Table~\ref{Table:Table_mr_clinical_scales_update_cortese}.
