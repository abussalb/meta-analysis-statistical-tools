...
\begin{itemize}
  \item \emph{the signal quality}: online rejection (epoch rejected, feedback not computed) or correction (feedback computed on the denoised epoch) of electrooculogram (EOG) artifacts; and online rejection of generic artifacts using an amplitude-based detection;
