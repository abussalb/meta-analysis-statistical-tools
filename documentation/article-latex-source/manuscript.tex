...
\todo{Since you are using gls, please use the gls command to generate the list of abbreviations}
...
\todo{I am sure there is a function to list figures with there captions without having to replicate the code.}
...
\todo{if you need to keep all these, please place this code in a different file and use input}

\section*{Table captions}
\todo{same comments for table as for Figures}
\begin{table}[h!]
  \centering
