...
% Work done here
Because of these criticisms and the concurrent publication of new \glspl{rct} meeting \citeauthor{Cortese2016}'s inclusion criteria, we
...
of the \gls{nfb} trials rather than suffering from it by extending the previous work with a novel method, the \glsfirst{saob}.} Indeed, the \gls{nfb} domain is 
