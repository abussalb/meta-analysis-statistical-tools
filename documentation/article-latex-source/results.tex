...
It is more doubtful the influence of the factors returned by only one or two methods \textcolor{red}{(see lines 3, 7, 15, 16, 18, and 20 of 
Table~\ref{Table:table_factors_analysis_results_summary})}. In particular: 
