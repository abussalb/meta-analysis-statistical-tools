...
def import_csv(csv_file, raters=''): 
    ...
    csv_file: str
        ...
        - nine columns: Author, Year, Group, Score Name, Number of patients, Raters, Time, Mean, Std;
        - each study has 4 lines if only parent assessments are available, 8 if teacher assessments are provided too: the Author name (repeated 4 or 8 times),
          Year (repeated 4 or 8 times), Group (NFB or control), Score Name, Raters (Parents or Teachers), Time (pre and post), Mean and Std;
        - for each author, the 4 lines of the Group column have to be filled as follows: NFB, NFB, Control, Control (pattern repeated one more time
