...
in the Supplemental Materials \comment{add exact reference here}. The work was carried with an open-source 
...
We provide in Supplemental Material \ref{} the raw data extracted from the publications. To prevent any bias, the names of these factors
...
%\comment{generally speaking try to insert your equations as part of the sentence you write. 
%The equation can finish with comma or period but also need to link with previous sentence}
