...
\comment{generally and throughout the manuscript, I would try to talk about a meta-analysis and not always about replication. Instead, I would in the methods and introduction explain what we are doing and why: updating the work with new evidence, taking choice from the lastes work (Corstese) and challenging some of his choices that proved contraversial. Then, I would stick to describing the results without always refering to Cortese - it is know your work with your hypothesis and choices} 
...
number of participants to meet [their] planned sample size.\end{quote}. Nevertheless not including them would also introduce bias.
...
on the \gls{pblind} outcome, adding two studies confirms this result on the total clinical score ($\text{p-value} < 0.05$). 
