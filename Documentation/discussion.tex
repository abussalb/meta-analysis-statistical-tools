...
%\comment{generally and throughout the manuscript, I would try to talk about a meta-analysis and not always about replication. 
%Instead, I would in the methods and introduction explain what we are doing and why: updating the work with new evidence
%, taking choice from the lastes work (Corstese) and challenging some of his choices that proved contraversial.
 %Then, I would stick to describing the results without always refering to Cortese - it is know your work with your hypothesis and choices} 
...
%The interpretation of factors returned only by two methods is less reliable. Keeping that in mind, it was interesting 
%to study the direction of their effect though: an \gls{irb} approval seems preferable implying that a well-conducted study 
%seems to lead to favorable results; a high session pace, so a more intensive training, appears to lead to better results,
...
Another way to highlight a possible placebo effect, is to focus on the difference between \gls{pblind} and \gls{mprox} raters at pre-test 
