...
\begin{figure}[h!]
  \centering
  %\fbox{\includegraphics[width=1.2\textwidth]{figures/meta_review_factors_analysis_how_studies_are_included_no_colors_2-columns_fitting_ima} }
	\includegraphics[width=1\textwidth]{figures/Image3} 
