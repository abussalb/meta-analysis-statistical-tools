...
% 148 words (less tha 150 required)
...
we first proposed to replicate and update the most recent one. Then, we tried to identify factors with an influence on Neurofeedback 
